...
// A collection of node aka vertices
// Node may point to other nodes, known as edges

const { createQueue } = require('./class2-queue-structure');
...
// graph.addNode('Kyle');
// graph.addNode('Anna');
// graph.addNode('Krios'); // cat
// graph.addNode('Tali');  // dog
//
...
// Personally? Don't really like this data structure.
